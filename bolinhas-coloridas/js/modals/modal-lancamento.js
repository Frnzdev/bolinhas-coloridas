...
function abrirModal(produto) {
  ...
  } else if (produto === "produto7") {
    modalImagem.src = "/src/Catalogo-Locacao/KiddiePlay.png"; // Imagem do produto 7
    modalTitulo.textContent = "KiddiePlay";
    modalDescricao.innerHTML =
      "Aqui está a descrição detalhada do KiddiePlay..";
  }
